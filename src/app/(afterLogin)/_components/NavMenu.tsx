...
const ExploreIcon = ({ filled }: { filled: boolean }) => (
  <svg
    width={26}
    viewBox='0 0 24 24'
    aria-hidden='true'
  ...
  const navItems: NavItem[] = [
    {
      ...
      segments: ['home'],
      icon: {
        active: <HomeIcon filled={true} />,
        inactive: <HomeIcon filled={false} />,
      },
    },
    {
      href: '/explore',
      label: '탐색하기',
      segments: ['search', 'explore'],
      icon: {
        active: <ExploreIcon filled={true} />,
        inactive: <ExploreIcon filled={false} />,
      },
    },
    {
      href: '/messages',
      ...
      segments: ['messages'],
      icon: {
        active: <MessagesIcon filled={true} />,
        inactive: <MessagesIcon filled={false} />,
      },
    },
  ];

  const isActive = (item: NavItem) => {
    if (!segment && item.href === '/home') return true;
    ...
    <>
      ...
      {me?.id &&
        renderNavItem({
          ...
          segments: [me.id],
          icon: {
            active: <ProfileIcon filled={true} />,
            inactive: <ProfileIcon filled={false} />,
          },
        })}
    </>
  );
